...
#define OW_FLAG_NO_ENCOUNTER        0x04F  // If this flag is set, wild encounters will be disabled.
#define OW_FLAG_NO_TRAINER_SEE      0x04E  // If this flag is set, trainers will not battle the player unless they're talked to.
